...
export default function AuthCallback() {
  ...
  useEffect(() => {
    ...
    const code = params.get('code');      // Step 6: Get code from URL
    const state = params.get('state');

    console.log('[6] Callback received with code and state');
    ...
    handleAuthCallback(code, state);      // Step 7: Send to exchange
